...
AND TO_CHAR(TRUNC(T.DATE_OF,'MM'), 'DDMMYYYY') = '01082017'
AND T.INS_DATE < TO_DATE('04.09.2017  9:27:55','DD.MM.YYYY HH24:MI:SS') --врем€ "закрыти€" мес€ца
--exclude >30
and T.ID not in (0)
...
AND   T.KIND=17 
AND TO_CHAR(TRUNC(T.DATE_OF,'MM'), 'DDMMYYYY') = '01082017'
AND T.INS_DATE < TO_DATE('04.09.2017  9:27:55','DD.MM.YYYY HH24:MI:SS') --close month
...
AND TO_CHAR(TRUNC(T.DATE_OF,'MM'), 'DDMMYYYY') = '01082017'
AND T.INS_DATE < TO_DATE('04.09.2017  9:27:55','DD.MM.YYYY HH24:MI:SS') --
--exclude >30
and T.ID not in (0)
--exclude STOLLEN CARD
AND t.card_num NOT IN (
