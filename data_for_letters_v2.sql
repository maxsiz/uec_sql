Select R2.*, R3.tickets_83, R4.kol_t as TRIPS_83 FROM (
SELECT MAX(R1.ID) as ID, R1.NAME, SUM(kol_p_3033) as kol_p_3033, SUM(kol_p_69) as kol_p_69, SUM(kol_p_83) as kol_p_83
FROM (
SELECT 
D.ID, D.NAME,
--, T.card_series,
...
SELECT R.ID, count(*) as tickets_83 FROM (
