--deti 30 33 r4
 select  O.CODE as CARRIER,SUBSTR(T.CARD_NUM,2) as CARD_NUM, decode(R.ID_CODE_MSG,200001000,R.CODE,0) as PRIGOROD_MARSH, count (*) as TRIP_COUNT
...
AND   T.KIND=16 
AND  T.INS_DATE between  TO_DATE('01.03.2017 03:00:00','DD.MM.YYYY HH24:MI:SS') 
                     and TO_DATE('01.04.2017 02:59:59','DD.MM.YYYY HH24:MI:SS') 
GROUP BY O.CODE, T.CARD_NUM, decode(R.ID_CODE_MSG,200001000,R.CODE,0) 
