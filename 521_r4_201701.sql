...
AND   T.KIND=17 
AND TO_CHAR(TRUNC(T.DATE_OF,'MM'), 'DDMMYYYY') = '01012017'
AND T.INS_DATE < TO_DATE('03.02.2017 8:31:42','DD.MM.YYYY HH24:MI:SS') --врем€ "закрыти€" мес€ца
--exclude >30
and T.ID not in (0)
...
AND   T.KIND=17 
AND TO_CHAR(TRUNC(T.DATE_OF,'MM'), 'DDMMYYYY') = '01012017'
AND T.INS_DATE < TO_DATE('03.02.2017 8:31:42','DD.MM.YYYY HH24:MI:SS') --close month
--exclude >30
and T.ID not in (0)
--exclude STOLLEN CARD
AND t.card_num NOT IN (
