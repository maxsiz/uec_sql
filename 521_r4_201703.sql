...
AND   T.KIND=17 
AND TO_CHAR(TRUNC(T.DATE_OF,'MM'), 'DDMMYYYY') = '01032017'
AND T.INS_DATE < TO_DATE('03.04.2017 9:41:11','DD.MM.YYYY HH24:MI:SS') --врем€ "закрыти€" мес€ца
--exclude >30
and T.ID not in (0)
--exclude STOLLEN CARD
AND t.card_num NOT IN (
 '0003024684' --test card
,'0200405049' --not identifyed uec
) 
...
AND   T.KIND=17 
AND TO_CHAR(TRUNC(T.DATE_OF,'MM'), 'DDMMYYYY') = '01032017'
AND T.INS_DATE < TO_DATE('03.04.2017 9:41:11','DD.MM.YYYY HH24:MI:SS') --close month
--exclude >30
and T.ID not in (0)
--exclude STOLLEN CARD
AND t.card_num NOT IN (
