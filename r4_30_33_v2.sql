...
--, T.*
 ...
 WHERE 
 (T.CARD_SERIES =33 
     or   (T.CARD_SERIES =30 and R.ID_CODE_MSG != 200001000))
...
AND   T.KIND=16 
AND  T.INS_DATE between  TO_DATE('01.02.2017 03:00:00','DD.MM.YYYY HH24:MI:SS') 
                     and TO_DATE('01.03.2017 02:59:59','DD.MM.YYYY HH24:MI:SS') 
