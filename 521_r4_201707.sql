...
AND T.INS_DATE < TO_DATE('02.08.2017  9:27:55','DD.MM.YYYY HH24:MI:SS') --врем€ "закрыти€" мес€ца
--exclude >30
and T.ID not in (0)
...
AND   T.KIND=17 
AND TO_CHAR(TRUNC(T.DATE_OF,'MM'), 'DDMMYYYY') = '01072017'
AND T.INS_DATE < TO_DATE('02.08.2017  9:27:55','DD.MM.YYYY HH24:MI:SS') --close month
